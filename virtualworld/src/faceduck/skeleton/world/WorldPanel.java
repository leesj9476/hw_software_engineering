...
public class WorldPanel extends JPanel implements Runnable {
	...
	// add my magician image
	private final ImageIcon magicianImage = new ImageIcon(getClass()
			.getResource("icons/magician.jpg"));
	...
	public void paintComponent(Graphics g) {
		...
		synchronized (WorldImpl.class) {
			for (Object thing : world.getAllObjects()) {
				...
				} else if (thing instanceof MagicianImpl) {
					// add my magician image to world
					magicianImage.paintIcon(this, g, x, y);
				} else {
