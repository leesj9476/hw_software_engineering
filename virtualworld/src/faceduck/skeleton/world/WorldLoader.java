...
public class WorldLoader {
	...
	// add my magician to world
	private void addMagician() {
		for (int i = 0; i < numMagician; i++) {
			Location loc = Util.randomEmptyLoc(world);
			if (loc != null) {
				// If the world isn't full
				world.add(new MagicianImpl(), loc);
			}
		}
	}
}
